globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/node_modules/.pnpm/node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/node_modules/.pnpm/std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/node_modules/.pnpm/h3@1.6.4/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/node_modules/.pnpm/@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"persistedState":{"storage":"cookies","debug":false,"cookieOptions":{}}}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/muhammadzahidnoor/Desktop/Projects/NuxtJS/nuxt-pinia/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
