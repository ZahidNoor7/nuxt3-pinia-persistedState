import { version, getCurrentInstance, inject, ref, watchEffect, watch, createApp, reactive, unref, useSSRContext, markRaw, effectScope, isRef, isReactive, toRaw, provide, onErrorCaptured, onServerPrefetch, getCurrentScope, onScopeDispose, nextTick, toRef, h, isReadonly, defineAsyncComponent, toRefs, computed } from 'vue';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs, ssrInterpolate } from 'vue/server-renderer';
...
const plugin_vue3_kNL3ApiyjF = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const router_TOmDUTHEsc = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugin_0D7Nd5WvTD = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><button>---</button><br><p>${ssrInterpolate(unref(counter).count)}</p><br><button>+++</button></div>`);
    };
  }
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-f8a042fd.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-39bf847b.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
